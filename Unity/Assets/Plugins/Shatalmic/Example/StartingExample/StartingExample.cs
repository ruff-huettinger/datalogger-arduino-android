...
{
    public string DeviceName = "ledbtnStart";
    ...
    void Start()
    {
        if (DeinitializeButton != null)
        {
            ...
            DeinitializeButton.SetActive(true);
        }
            ...
            if (_timeout <= 0f)
            {
                ...
                switch (_state)
                {
                    ...
                    case States.Disconnect:
                        ...
                        {
                            /*
                            StatusMessage = "Now dcing";
                            BluetoothLEHardwareInterface.DisconnectPeripheral(DeviceName, (address) =>
                            {
    ...
    public void OnLED()
    {
        Debug.LogWarning("Pressed Toggle Button");
